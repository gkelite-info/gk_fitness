  ...
  return (
    ...
    >
      <View className="items-center mb-8">
        ...
        <Text className="text-white text-2xl font-semibold mb-1">{name || 'User'}</Text>
        <Text className="text-[#8E8E93] text-sm mb-3">{email || 'user@gkfitness.com'}</Text>
      ...
      <View className="bg-[#121214] border border-[#27272A] rounded-2xl p-4 mb-6">
        <View className="flex-row justify-between py-3 border-b border-[#27272A]">
          ...
          <Text className="text-white text-sm font-semibold">{getRoleDisplayName(role)}</Text>
        </View>
