...
export default function WeeklyWorkoutPlan() {
  ...
  const { data: loadedPlanDays, isLoading, refetch } = useTrainerWeeklyPlan(customerId);
  ...
  const handleEdit = (dayId: string) => {
    router.push({
      pathname: '/(trainer)/weeklyWorkoutPlan/edit-day',
      params: { day: dayId, customerId }
    });
  };
              ...
              >
                ...
                {day.isRest ? (
                  ...
                  <View className="flex-row items-center gap-1.5 ml-2">
                    <Pressable
                      onPress={() => router.push({ pathname: '/(trainer)/weeklyWorkoutPlan/view-day', params: { dayId: day.id, customerId } })}
                    ...
                    <Pressable
                      onPress={() => router.push({ pathname: '/(trainer)/weeklyWorkoutPlan/swap-day', params: { dayId: day.id, customerId } })}
                    ...
                    <Pressable onPress={() => router.push({ pathname: '/(trainer)/weeklyWorkoutPlan/view-day', params: { dayId: day.id, customerId } })} className="p-2 -mr-2">
